...
GraphQL is a new tool for exchanging data over the internet-web.  It is awesome.
Semantically, it is similar to how spoken language is structure (at least English).  
Visually, it looks really cool and when you structure a data query the structure 
of the query looks similar to the resulting data set.  As the name implies it relies 
on a graph topology so the data can be visualized in graph/edges/and nodes structure.  
This makes it easier to determine relationships within the database.
